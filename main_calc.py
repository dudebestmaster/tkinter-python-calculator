...
button_add = Button(root, text="+", padx=40, pady=25, command=button_add)
button_subtract = Button(root, text="-", padx=40, pady=25, command=button_subtract)
button_multiply = Button(root, text="x", padx=40, pady=25, command=button_multiply)
button_division = Button(root, text="/", padx=40, pady=25, command=button_divide)
button_clear = Button(root, text="Clear", padx=26, pady=25, command=button_clear)
button_equal = Button(root, text="=", padx=40, pady=25, command=button_equal)
button_quit = Button(root, text="Exit", padx=31, pady=25, command=root.quit)
